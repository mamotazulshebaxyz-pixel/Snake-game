...
function draw(){
    ...
    // ======= 🕹️ ওল্ড-স্কুল পিক্সেল আর্ট সাপ (ফিক্সড ও পারফেক্ট লুক) =======
    snake.forEach((part, index) => {
        // সাপের বডির কালার (আপনার গেমের ডার্ক ব্যাকগ্রাউন্ডের সাথে ম্যাচিং ডার্ক ব্লু-ব্ল্যাক)
        ctx.fillStyle = "#091318"; 
        
        // চারকোনা পিক্সেল বডি ড্র করা (১ পিক্সেল গ্যাপ রেখে যেন আলাদা ব্লক বোঝা যায়)
        ctx.fillRect(part.x + 1, part.y + 1, 18, 18);
        
        // মাঝখানের পিক্সেল ফাঁকা অংশ (ডট) তৈরি করা
        // clearRect এর বদলে এখানে আমরা ক্যানভাসের মাঝের গ্রিড লাইনের কালার বা ব্যাকগ্রাউন্ড অনুযায়ী 
        // সরাসরি ফিল করে দেব, যেন নিচের গ্রিড দেখা না যায় এবং হুবহু নোকিয়া স্টাইল লাগে।
        ctx.fillStyle = "#203a43"; // ওয়াটার ব্যাকগ্রাউন্ডের মিডল কালার
        ctx.fillRect(
            part.x + 20 / 3, 
            part.y + 20 / 3, 
            20 / 3, 
